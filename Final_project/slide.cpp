...
public:
    ...
    virtual SlideTransition RunSlide() override {
        PrepAudio(audio, "Aeroplane_intro.wav"); 
        PlayBGMAudio(audio);
...
public:
    Slide_sselvam2() : Slide() {
        ...
        std::string png1Path = "wings.png";
        std::string png2Path = "wingsssss.png";
    ...
    while (FsCheckWindowOpen()) {
        if (currentSlide == nullptr) {
            if (currentSlideIndex == 0) {
                currentSlide = new Slide_sselvam1();      
            } else if (currentSlideIndex == 1) {
                currentSlide = new Slide_sselvam3();       
            } else if (currentSlideIndex == 2) {
                currentSlide = new Slide_sselvam2();      
            } else if (currentSlideIndex == 3) {           
                currentSlide = new Slide_andrewID2();      
            }
        }
